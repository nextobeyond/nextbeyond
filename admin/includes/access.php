...
function teacherMenuSettings(): array
{
    return [
        ...
        'teacher_test_access' => ['แบบทดสอบและคลังข้อสอบ', ['tests.php', 'question-bank.php', 'exams-api.php', 'export-exam-docx.php', 'live-sessions.php', 'live-session-room.php', 'live-sessions-api.php']],
        'teacher_worksheet_access' => ['คลังใบงานและ AI สร้างใบงาน', ['worksheets.php', 'worksheet-detail.php', 'ai-worksheet.php', 'worksheets-api.php']],
...
if (str_contains($_SERVER['SCRIPT_FILENAME'] ?? '', '/ai-exam-app/')) $requestedPage = 'ai-exam.php';
