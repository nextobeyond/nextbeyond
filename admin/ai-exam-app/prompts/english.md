...
- รูปแบบคำตอบปรนัย: `questionText` มีเฉพาะคำถาม บทอ่าน หรือบทสนทนา ห้ามใส่หมายเลขข้อ ตัวเลือก A, B, C, D หรือเฉลยซ้ำใน `questionText` ให้ส่งตัวเลือกแต่ละข้อแยกใน `options` เท่านั้น และข้อความใน `options` ไม่ต้องขึ้นต้นด้วย A., B., C., D.
