...
- รูปแบบคำตอบปรนัย: `questionText` มีเฉพาะคำถามหรือข้อมูลประกอบ ห้ามใส่หมายเลขข้อ ตัวเลือก ก, ข, ค, ง หรือเฉลยซ้ำใน `questionText` ให้ส่งตัวเลือกแต่ละข้อแยกใน `options` เท่านั้น และข้อความใน `options` ไม่ต้องขึ้นต้นด้วย ก., ข., ค., ง.
